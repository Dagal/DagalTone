...
mInputModuleGroup("EntrÈe"),
mMidiInputButton("EntrÈes Midi"),
mAudioInputButton("EntrÈes Audio"),
mOutputModuleGroup("Sortie"),
mMidiOutputButton("Sorties Midi"),
mAudioOutputButton("Sorties Audio"),
mGeneratorGroup("GÈnÈrateur de signaux"),
mSinusoidGeneratorButton("SinusoÔde"),
mEffectGroup("Effets"),
mVolumeControlButton("ContrÙle de volume"),
...
mButton3("Test Button 3")
{
	...
	// Cr√©ation du menu √† l'aide de balise xml
	...
	{
		std::cerr << "La cr√©ation du menu a √©chou√©!:" << ex.what() << std::endl;
	}
...
void CDagalTone::on_input_pressed()
{
	...
	//std::cerr << "D√©placement vers " << x << "," << y << std::endl;
}
